 ...
 * @author johnm
 */
public class Transacton extends javax.swing.JFrame {

    /**
     * Creates new form Transacton
     */
    public Transacton() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Transacton.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Transacton().setVisible(true);
            }
        });
    }
